...
import ShippingCompanyOptionItem from "./ShippingCompanyOptionItem";
      ...
      >
        ...
        <div>
          <div className="flex justify-start items-center gap-4">
            <h3 className="font-medium">خيارات شركات الشحن</h3>
          </div>
          <p className="text-lg">
            امنح شركات الشحن إذن تحديث حالة الطلب ومزامنة الكميات وصلاحيات اخرى
          </p>
        </div>
      </div>
        ...
        <div className="shadow-lg md:w-[800px] rounded-lg overflow-hidden">
          ...
          <div className="bg-white py-4 text-lg">
            <ShippingCompanyOptionItem
              title={"السماح لشركات الشحن بتغيير حالة الطلب"}
              desc={
                "بعض شركات الشحن توفر خاصية لتغيير حالة الطلبات تلقائياً، بناءً على حالة الشحن"
              }
              active
            />
            <ShippingCompanyOptionItem
              title={"السماح لشركات الشحن بمزامنة الكميات"}
              desc={"بعض شركات الشحن توفر خاصية مزامنة الكميات"}
              active
            />
            <ShippingCompanyOptionItem
              title={"عرض شركة شحن واحدة من الشركات الخاصة عند"}
              desc={"وجود تطابق لرسوم الشحن في صفحة إنهاء الطلب"}
              active
            />
            <ShippingCompanyOptionItem
              title={
                "إرسال بيانات المنتجات الفرعية ضمن منتج من نوع , مجموعة منتجات"
              }
              desc={
                "عند تفعيل هذا الخيار سيتم إرسال تفاصيل المنتج المجمع مع تفاصيل المنتجات الفرعية إلى شركة الشحن"
              }
              active
            />
            <ShippingCompanyOptionItem
              title={
                "السماح للنظام بتحديد المستودع بشكل تلقائي حسب مدينة العميل"
              }
              desc={
                "عند تفعيل الخيار سيقوم النظام باختيار المستودع (إن وجد) حسب المدينة فيعنوان الشحن وذلك عند تحويل الطلب إلى : تم التنفيذ"
              }
              active={false}
            />
            <ShippingCompanyOptionItem
              title={"السماح لشركات الشحن بتصدير بوليصة لطلب غير مكتمل"}
              desc={
                "بعض شركات الشحن تقوم بإصدار بوليصة للطلب بمجرد إنشاءه (قبل ان تكون حالته تم التنفيذ)"
              }
              active
            />
          </div>
