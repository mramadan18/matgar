  ...
  return (
    <section>
      ...
      <div className="border border-[#707070] py-5 mt-8 rounded-lg tracking-widest">
        ...
        <div>
          <p className="p-5 text-lg opacity-50 ">
            تسمح لك هذه الخاصية البحث عن العمليات التي تمت في متجرك بواسطة وسائل
            الدفع الإلكتروني (خلال الـ 30 يوم الماضية)
          </p>
        </div>
        ...
        <div className="relative rounded-lg overflow-hidden px-5">
          <select
            id="countries"
            className="block w-full rounded-md border-0 p-2.5  text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6  "
          >
        ...
        <div className=" title--hero w-full center mt-8">
          <p className="opacity-70 ">لم يتم العثور على اي نتائج للبحث</p>
        </div>
      </div>
