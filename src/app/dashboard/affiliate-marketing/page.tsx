...
import mainImg from "#/img for salla/dashboard/Cohort analysis-rafiki.png";
  ...
  return (
    <section>
      ...
      <div className="flex flex-col items-center">
        ...
        <h2 className="tracking-wider">لم تقم بإضافة اي روابط</h2>
        <p className="text-base mb-3">
          ابدأ رحلة التسويق عبر العمولة بإضافة رابط تسويق بالعمولة الآن
        </p>
        <button
          className="rounded-lg py-2 text-lg mt-4"
      ...
      <Modal showModal={modalOpen} setShowModal={setModalOpen}>
        <div className="shadow-lg md:w-[650px] rounded-lg overflow-hidden">
          <div className="bg-primary py-2 px-4 flex justify-between items-center w-full text-white text-xl font-medium">
            <p>إضافة رابط للتسويق بالعمولة</p>
            <AiOutlineClose
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-base">
                  ادخل البيانات الأساسية لإنشاء رابط جديد للتسويق بالعمولة
                </p>
              </div>
